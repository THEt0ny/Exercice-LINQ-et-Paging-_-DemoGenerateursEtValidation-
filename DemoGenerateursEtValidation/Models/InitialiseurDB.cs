...
namespace DemoGenerateursEtValidation.Models
{
    public static class InitialiseurDB
    {
        ...
        private static Dictionary<string, Auto> _ModeleAutoDict;

        public static Dictionary<string, Auto> ModeleAutoDict
        {
            get
            {
                _ModeleAutoDict = new Dictionary<string, Auto>();
                foreach(Auto auto in _autos)
                {
                    _ModeleAutoDict.Add(auto.Model, auto);
                }

                return _ModeleAutoDict;
            }
        }
        ...
        {
            CatalogueAutoDbContext catalogueAutoDbContext =
            ...
            .ServiceProvider.GetRequiredService<CatalogueAutoDbContext>();
             ...
             {
                catalogueAutoDbContext.Autos.AddRange(ModeleAutoDict.Values);
             }
